...
class myntAssetsViewer{
	...
	*/
	...
	private function getRPCresults($command, $param = '')
	{
		...
		$mynt = new Mynt($this->cfg['rpcUsername'],$this->cfg['rpcPassword'],$this->cfg['rpcHostIP'],$this->cfg['rpcHostPort']);
		return $mynt->$command($param);
	}
}
?>
